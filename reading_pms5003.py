# kpark
# Using adafruit CircuitPython code
# Source: https://learn.adafruit.com/pm25-air-quality-sensor/circuitpython-code
# Just busio is changed into serial (Raspberry pi used)
